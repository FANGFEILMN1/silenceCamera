...
import com.example.takephotosilence.MatrixImageView.OnMovingListener;
import com.example.takephotosilence.MatrixImageView.OnSingleTapListener;
...
//					throw new RuntimeException("onPlayVideoListener is null");
		...
		public String deleteCurrentItem(int position) {
			...
			String path=paths.get(position);
			if(path!=null) {
				Log.e(TAG, "deleteCurrentItem"+path);
